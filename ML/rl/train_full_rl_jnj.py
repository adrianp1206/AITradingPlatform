...
if __name__ == "__main__":
    ...
    #     xgb_features=['HT_DCPERIOD', 'MEDPRICE', 'HT_DCPHASE', 'MACD_signal', 'HT_TRENDMODE', 'STOCH_fastd', 'AROON_UP', 'HT_SINE', 'MINUS_DM', 'HT_PHASOR_quadrature', 'BB_middle', 'NATR', 'ADXR', 'TYPPRICE', 'MIDPRICE', 'RSI', 'BB_lower', 'AROONOSC', 'AROON_DOWN', 'ADOSC', 'DEMA', 'PLUS_DM', 'CMO', 'AVGPRICE', 'MOM', 'ROC', 'STOCH_slowk', 'TRIMA', 'T3', 'MIDPOINT', 'SMA', 'CCI', 'STOCH_fastk'],
    #     output_path="JNJ_RL_input.csv"
    # )
